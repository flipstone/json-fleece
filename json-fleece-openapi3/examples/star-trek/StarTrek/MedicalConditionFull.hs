...
import qualified StarTrek.MedicalConditionFull.Name as Name
import qualified StarTrek.MedicalConditionFull.PsychologicalCondition as PsychologicalCondition
import qualified StarTrek.MedicalConditionFull.Uid as Uid
