...
module StarTrek.Operations.MagazineSeries.Search.POST
  ( operation
  , route
  , QueryParams(..)
  , queryParamsSchema
...
import qualified StarTrek.Operations.MagazineSeries.Search.POST.ApiKey as ApiKey
import qualified StarTrek.Operations.MagazineSeries.Search.POST.PageNumber as PageNumber
import qualified StarTrek.Operations.MagazineSeries.Search.POST.PageSize as PageSize
import qualified StarTrek.Operations.MagazineSeries.Search.POST.Sort as Sort
