...
import qualified StarTrek.Operations.BookSeries.ApiKey as ApiKey
import qualified StarTrek.Operations.BookSeries.Uid as Uid
import qualified StarTrek.Types.BookSeriesFullResponse as BookSeriesFullResponse
...
data Responses
  = Response200 BookSeriesFullResponse.BookSeriesFullResponse
