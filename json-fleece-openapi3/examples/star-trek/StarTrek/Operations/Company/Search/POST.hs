...
module StarTrek.Operations.Company.Search.POST
  ( operation
  , route
  , QueryParams(..)
  , queryParamsSchema
...
import qualified StarTrek.Operations.Company.Search.POST.ApiKey as ApiKey
import qualified StarTrek.Operations.Company.Search.POST.PageNumber as PageNumber
import qualified StarTrek.Operations.Company.Search.POST.PageSize as PageSize
import qualified StarTrek.Operations.Company.Search.POST.Sort as Sort
import qualified StarTrek.Types.CompanyBaseResponse as CompanyBaseResponse
