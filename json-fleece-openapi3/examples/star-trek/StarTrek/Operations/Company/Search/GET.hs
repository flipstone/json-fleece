...
module StarTrek.Operations.Company.Search.GET
  ( operation
  , route
  , QueryParams(..)
  , queryParamsSchema
...
import qualified StarTrek.Operations.Company.Search.GET.ApiKey as ApiKey
import qualified StarTrek.Operations.Company.Search.GET.PageNumber as PageNumber
import qualified StarTrek.Operations.Company.Search.GET.PageSize as PageSize
