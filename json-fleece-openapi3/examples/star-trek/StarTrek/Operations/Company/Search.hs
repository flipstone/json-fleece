...
module StarTrek.Operations.Company.Search
  ( operation
  , route
  , QueryParams(..)
  , queryParamsSchema
...
import qualified StarTrek.Operations.Company.Search.ApiKey as ApiKey
import qualified StarTrek.Operations.Company.Search.PageNumber as PageNumber
import qualified StarTrek.Operations.Company.Search.PageSize as PageSize
