...
import qualified StarTrek.Types.ComicCollectionFullResponse as ComicCollectionFullResponse
...
data Responses
  = Response200 ComicCollectionFullResponse.ComicCollectionFullResponse
