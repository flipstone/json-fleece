...
import qualified StarTrek.Operations.Character.ApiKey as ApiKey
import qualified StarTrek.Operations.Character.Uid as Uid
import qualified StarTrek.Types.CharacterFullResponse as CharacterFullResponse
...
data Responses
  = Response200 CharacterFullResponse.CharacterFullResponse
