...
module StarTrek.Operations.Material.Search
  ( operation
  , PathParams(..)
  , route
  , QueryParams(..)
...
import qualified StarTrek.Operations.Material.Search.ApiKey as ApiKey
import qualified StarTrek.Operations.Material.Search.PageNumber as PageNumber
import qualified StarTrek.Operations.Material.Search.PageSize as PageSize
