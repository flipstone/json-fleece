...
module StarTrek.Operations.Material.Search.GET
  ( operation
  , route
  , QueryParams(..)
  , queryParamsSchema
...
import qualified StarTrek.Operations.Material.Search.GET.ApiKey as ApiKey
import qualified StarTrek.Operations.Material.Search.GET.PageNumber as PageNumber
import qualified StarTrek.Operations.Material.Search.GET.PageSize as PageSize
