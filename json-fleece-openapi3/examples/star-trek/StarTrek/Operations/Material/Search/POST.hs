...
module StarTrek.Operations.Material.Search.POST
  ( operation
  , route
  , QueryParams(..)
  , queryParamsSchema
...
import qualified StarTrek.Operations.Material.Search.POST.ApiKey as ApiKey
import qualified StarTrek.Operations.Material.Search.POST.PageNumber as PageNumber
import qualified StarTrek.Operations.Material.Search.POST.PageSize as PageSize
import qualified StarTrek.Operations.Material.Search.POST.Sort as Sort
import qualified StarTrek.Types.MaterialBaseResponse as MaterialBaseResponse
