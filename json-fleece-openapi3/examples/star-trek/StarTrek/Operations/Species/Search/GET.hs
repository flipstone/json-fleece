...
module StarTrek.Operations.Species.Search.GET
  ( operation
  , route
  , QueryParams(..)
  , queryParamsSchema
...
import qualified StarTrek.Operations.Species.Search.GET.ApiKey as ApiKey
import qualified StarTrek.Operations.Species.Search.GET.PageNumber as PageNumber
import qualified StarTrek.Operations.Species.Search.GET.PageSize as PageSize
