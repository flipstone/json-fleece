...
module StarTrek.Operations.Species.Search
  ( operation
  , PathParams(..)
  , route
  , QueryParams(..)
...
import qualified StarTrek.Operations.Species.Search.ApiKey as ApiKey
import qualified StarTrek.Operations.Species.Search.PageNumber as PageNumber
import qualified StarTrek.Operations.Species.Search.PageSize as PageSize
