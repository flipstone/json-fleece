...
import qualified StarTrek.Operations.Animal.ApiKey as ApiKey
import qualified StarTrek.Operations.Animal.Uid as Uid
import qualified StarTrek.Types.AnimalFullResponse as AnimalFullResponse
...
data Responses
  = Response200 AnimalFullResponse.AnimalFullResponse
