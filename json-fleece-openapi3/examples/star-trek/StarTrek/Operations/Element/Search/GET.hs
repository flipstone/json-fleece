...
module StarTrek.Operations.Element.Search.GET
  ( operation
  , route
  , QueryParams(..)
  , queryParamsSchema
...
import qualified StarTrek.Operations.Element.Search.GET.ApiKey as ApiKey
import qualified StarTrek.Operations.Element.Search.GET.PageNumber as PageNumber
import qualified StarTrek.Operations.Element.Search.GET.PageSize as PageSize
