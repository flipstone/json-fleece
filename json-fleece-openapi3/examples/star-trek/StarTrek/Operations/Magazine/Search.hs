...
module StarTrek.Operations.Magazine.Search
  ( operation
  , route
  , QueryParams(..)
  , queryParamsSchema
...
import qualified StarTrek.Operations.Magazine.Search.ApiKey as ApiKey
import qualified StarTrek.Operations.Magazine.Search.PageNumber as PageNumber
import qualified StarTrek.Operations.Magazine.Search.PageSize as PageSize
