...
module StarTrek.Operations.Magazine.Search.POST
  ( operation
  , route
  , QueryParams(..)
  , queryParamsSchema
...
import qualified StarTrek.Operations.Magazine.Search.POST.ApiKey as ApiKey
import qualified StarTrek.Operations.Magazine.Search.POST.PageNumber as PageNumber
import qualified StarTrek.Operations.Magazine.Search.POST.PageSize as PageSize
import qualified StarTrek.Operations.Magazine.Search.POST.Sort as Sort
import qualified StarTrek.Types.MagazineBaseResponse as MagazineBaseResponse
