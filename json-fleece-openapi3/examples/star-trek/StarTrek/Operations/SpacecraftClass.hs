...
import qualified StarTrek.Types.SpacecraftClassFullResponse as SpacecraftClassFullResponse
...
data Responses
  = Response200 SpacecraftClassFullResponse.SpacecraftClassFullResponse
