...
module StarTrek.Operations.SpacecraftClass.Search
  ( operation
  , PathParams(..)
  , route
  , QueryParams(..)
...
import qualified StarTrek.Operations.SpacecraftClass.Search.ApiKey as ApiKey
import qualified StarTrek.Operations.SpacecraftClass.Search.PageNumber as PageNumber
import qualified StarTrek.Operations.SpacecraftClass.Search.PageSize as PageSize
