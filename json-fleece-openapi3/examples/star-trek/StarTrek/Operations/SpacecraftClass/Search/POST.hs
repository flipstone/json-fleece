...
module StarTrek.Operations.SpacecraftClass.Search.POST
  ( operation
  , route
  , QueryParams(..)
  , queryParamsSchema
...
import qualified StarTrek.Operations.SpacecraftClass.Search.POST.ApiKey as ApiKey
import qualified StarTrek.Operations.SpacecraftClass.Search.POST.PageNumber as PageNumber
import qualified StarTrek.Operations.SpacecraftClass.Search.POST.PageSize as PageSize
import qualified StarTrek.Operations.SpacecraftClass.Search.POST.Sort as Sort
import qualified StarTrek.Types.SpacecraftClassBaseResponse as SpacecraftClassBaseResponse
