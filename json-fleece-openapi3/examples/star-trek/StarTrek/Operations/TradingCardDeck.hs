...
import qualified StarTrek.Types.TradingCardDeckFullResponse as TradingCardDeckFullResponse
...
data Responses
  = Response200 TradingCardDeckFullResponse.TradingCardDeckFullResponse
