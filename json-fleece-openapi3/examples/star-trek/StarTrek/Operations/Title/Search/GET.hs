...
module StarTrek.Operations.Title.Search.GET
  ( operation
  , route
  , QueryParams(..)
  , queryParamsSchema
...
import qualified StarTrek.Operations.Title.Search.GET.ApiKey as ApiKey
import qualified StarTrek.Operations.Title.Search.GET.PageNumber as PageNumber
import qualified StarTrek.Operations.Title.Search.GET.PageSize as PageSize
