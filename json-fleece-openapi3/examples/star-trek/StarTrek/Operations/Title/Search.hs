...
module StarTrek.Operations.Title.Search
  ( operation
  , route
  , QueryParams(..)
  , queryParamsSchema
...
import qualified StarTrek.Operations.Title.Search.ApiKey as ApiKey
import qualified StarTrek.Operations.Title.Search.PageNumber as PageNumber
import qualified StarTrek.Operations.Title.Search.PageSize as PageSize
