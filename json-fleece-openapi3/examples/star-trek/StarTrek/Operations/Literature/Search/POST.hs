...
module StarTrek.Operations.Literature.Search.POST
  ( operation
  , route
  , QueryParams(..)
  , queryParamsSchema
...
import qualified StarTrek.Operations.Literature.Search.POST.ApiKey as ApiKey
import qualified StarTrek.Operations.Literature.Search.POST.PageNumber as PageNumber
import qualified StarTrek.Operations.Literature.Search.POST.PageSize as PageSize
import qualified StarTrek.Operations.Literature.Search.POST.Sort as Sort
import qualified StarTrek.Types.LiteratureBaseResponse as LiteratureBaseResponse
