...
module StarTrek.Operations.Literature.Search.GET
  ( operation
  , route
  , QueryParams(..)
  , queryParamsSchema
...
import qualified StarTrek.Operations.Literature.Search.GET.ApiKey as ApiKey
import qualified StarTrek.Operations.Literature.Search.GET.PageNumber as PageNumber
import qualified StarTrek.Operations.Literature.Search.GET.PageSize as PageSize
