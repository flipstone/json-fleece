...
module StarTrek.Operations.BookSeries.Search
  ( operation
  , PathParams(..)
  , route
  , QueryParams(..)
...
import qualified StarTrek.Operations.BookSeries.Search.ApiKey as ApiKey
import qualified StarTrek.Operations.BookSeries.Search.PageNumber as PageNumber
import qualified StarTrek.Operations.BookSeries.Search.PageSize as PageSize
