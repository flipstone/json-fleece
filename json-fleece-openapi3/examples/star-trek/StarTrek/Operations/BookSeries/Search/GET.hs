...
module StarTrek.Operations.BookSeries.Search.GET
  ( operation
  , route
  , QueryParams(..)
  , queryParamsSchema
...
import qualified StarTrek.Operations.BookSeries.Search.GET.ApiKey as ApiKey
import qualified StarTrek.Operations.BookSeries.Search.GET.PageNumber as PageNumber
import qualified StarTrek.Operations.BookSeries.Search.GET.PageSize as PageSize
