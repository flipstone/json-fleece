...
module StarTrek.Operations.BookSeries.Search.POST
  ( operation
  , route
  , QueryParams(..)
  , queryParamsSchema
...
import qualified StarTrek.Operations.BookSeries.Search.POST.ApiKey as ApiKey
import qualified StarTrek.Operations.BookSeries.Search.POST.PageNumber as PageNumber
import qualified StarTrek.Operations.BookSeries.Search.POST.PageSize as PageSize
import qualified StarTrek.Operations.BookSeries.Search.POST.Sort as Sort
import qualified StarTrek.Types.BookSeriesBaseResponse as BookSeriesBaseResponse
