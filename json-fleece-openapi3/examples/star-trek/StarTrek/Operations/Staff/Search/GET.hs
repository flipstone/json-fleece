...
module StarTrek.Operations.Staff.Search.GET
  ( operation
  , route
  , QueryParams(..)
  , queryParamsSchema
...
import qualified StarTrek.Operations.Staff.Search.GET.ApiKey as ApiKey
import qualified StarTrek.Operations.Staff.Search.GET.PageNumber as PageNumber
import qualified StarTrek.Operations.Staff.Search.GET.PageSize as PageSize
