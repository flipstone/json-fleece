...
import qualified StarTrek.Operations.Organization.ApiKey as ApiKey
import qualified StarTrek.Operations.Organization.Uid as Uid
import qualified StarTrek.Types.Error as Error
import qualified StarTrek.Types.OrganizationFullResponse as OrganizationFullResponse
...
data Responses
  = Response200 OrganizationFullResponse.OrganizationFullResponse
