...
module StarTrek.Operations.AstronomicalObject.Search
  ( operation
  , PathParams(..)
  , route
  , QueryParams(..)
...
import qualified StarTrek.Operations.AstronomicalObject.Search.ApiKey as ApiKey
import qualified StarTrek.Operations.AstronomicalObject.Search.PageNumber as PageNumber
import qualified StarTrek.Operations.AstronomicalObject.Search.PageSize as PageSize
