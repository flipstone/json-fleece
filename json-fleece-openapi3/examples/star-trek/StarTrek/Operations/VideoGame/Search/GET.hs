...
module StarTrek.Operations.VideoGame.Search.GET
  ( operation
  , route
  , QueryParams(..)
  , queryParamsSchema
...
import qualified StarTrek.Operations.VideoGame.Search.GET.ApiKey as ApiKey
import qualified StarTrek.Operations.VideoGame.Search.GET.PageNumber as PageNumber
import qualified StarTrek.Operations.VideoGame.Search.GET.PageSize as PageSize
