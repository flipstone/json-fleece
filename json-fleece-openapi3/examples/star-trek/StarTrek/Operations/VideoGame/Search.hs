...
module StarTrek.Operations.VideoGame.Search
  ( operation
  , PathParams(..)
  , route
  , QueryParams(..)
...
import qualified StarTrek.Operations.VideoGame.Search.ApiKey as ApiKey
import qualified StarTrek.Operations.VideoGame.Search.PageNumber as PageNumber
import qualified StarTrek.Operations.VideoGame.Search.PageSize as PageSize
