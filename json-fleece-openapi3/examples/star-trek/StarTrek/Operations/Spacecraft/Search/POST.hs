...
module StarTrek.Operations.Spacecraft.Search.POST
  ( operation
  , route
  , QueryParams(..)
  , queryParamsSchema
...
import qualified StarTrek.Operations.Spacecraft.Search.POST.ApiKey as ApiKey
import qualified StarTrek.Operations.Spacecraft.Search.POST.PageNumber as PageNumber
import qualified StarTrek.Operations.Spacecraft.Search.POST.PageSize as PageSize
import qualified StarTrek.Operations.Spacecraft.Search.POST.Sort as Sort
import qualified StarTrek.Types.SpacecraftBaseResponse as SpacecraftBaseResponse
