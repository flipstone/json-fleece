...
module StarTrek.Operations.Spacecraft.Search
  ( operation
  , PathParams(..)
  , route
  , QueryParams(..)
...
import qualified StarTrek.Operations.Spacecraft.Search.ApiKey as ApiKey
import qualified StarTrek.Operations.Spacecraft.Search.PageNumber as PageNumber
import qualified StarTrek.Operations.Spacecraft.Search.PageSize as PageSize
