...
module StarTrek.Operations.Series.Search.POST
  ( operation
  , route
  , QueryParams(..)
  , queryParamsSchema
...
import qualified StarTrek.Operations.Series.Search.POST.ApiKey as ApiKey
import qualified StarTrek.Operations.Series.Search.POST.PageNumber as PageNumber
import qualified StarTrek.Operations.Series.Search.POST.PageSize as PageSize
import qualified StarTrek.Operations.Series.Search.POST.Sort as Sort
