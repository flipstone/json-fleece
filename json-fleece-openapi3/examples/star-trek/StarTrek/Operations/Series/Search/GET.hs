...
module StarTrek.Operations.Series.Search.GET
  ( operation
  , route
  , QueryParams(..)
  , queryParamsSchema
...
import qualified StarTrek.Operations.Series.Search.GET.ApiKey as ApiKey
import qualified StarTrek.Operations.Series.Search.GET.PageNumber as PageNumber
import qualified StarTrek.Operations.Series.Search.GET.PageSize as PageSize
