...
module StarTrek.Operations.Technology.Search
  ( operation
  , route
  , QueryParams(..)
  , queryParamsSchema
...
import qualified StarTrek.Operations.Technology.Search.ApiKey as ApiKey
import qualified StarTrek.Operations.Technology.Search.PageNumber as PageNumber
import qualified StarTrek.Operations.Technology.Search.PageSize as PageSize
