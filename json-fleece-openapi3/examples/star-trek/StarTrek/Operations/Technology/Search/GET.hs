...
module StarTrek.Operations.Technology.Search.GET
  ( operation
  , route
  , QueryParams(..)
  , queryParamsSchema
...
import qualified StarTrek.Operations.Technology.Search.GET.ApiKey as ApiKey
import qualified StarTrek.Operations.Technology.Search.GET.PageNumber as PageNumber
import qualified StarTrek.Operations.Technology.Search.GET.PageSize as PageSize
