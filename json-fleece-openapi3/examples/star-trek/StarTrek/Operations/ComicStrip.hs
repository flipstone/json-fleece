...
import qualified StarTrek.Operations.ComicStrip.ApiKey as ApiKey
import qualified StarTrek.Operations.ComicStrip.Uid as Uid
import qualified StarTrek.Types.ComicStripFullResponse as ComicStripFullResponse
...
data Responses
  = Response200 ComicStripFullResponse.ComicStripFullResponse
