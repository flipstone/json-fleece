...
module StarTrek.Operations.TradingCardDeck.Search.POST
  ( operation
  , route
  , QueryParams(..)
  , queryParamsSchema
...
import qualified StarTrek.Operations.TradingCardDeck.Search.POST.ApiKey as ApiKey
import qualified StarTrek.Operations.TradingCardDeck.Search.POST.PageNumber as PageNumber
import qualified StarTrek.Operations.TradingCardDeck.Search.POST.PageSize as PageSize
import qualified StarTrek.Operations.TradingCardDeck.Search.POST.Sort as Sort
import qualified StarTrek.Types.TradingCardDeckBaseResponse as TradingCardDeckBaseResponse
...
queryParamsSchema :: P.ParameterSchema p => p QueryParams QueryParams
queryParamsSchema =
