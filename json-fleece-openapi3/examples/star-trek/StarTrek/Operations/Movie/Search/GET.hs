...
module StarTrek.Operations.Movie.Search.GET
  ( operation
  , route
  , QueryParams(..)
  , queryParamsSchema
...
import qualified StarTrek.Operations.Movie.Search.GET.ApiKey as ApiKey
import qualified StarTrek.Operations.Movie.Search.GET.PageNumber as PageNumber
import qualified StarTrek.Operations.Movie.Search.GET.PageSize as PageSize
