...
module StarTrek.Operations.Movie.Search.POST
  ( operation
  , route
  , QueryParams(..)
  , queryParamsSchema
...
import qualified StarTrek.Operations.Movie.Search.POST.ApiKey as ApiKey
import qualified StarTrek.Operations.Movie.Search.POST.PageNumber as PageNumber
import qualified StarTrek.Operations.Movie.Search.POST.PageSize as PageSize
import qualified StarTrek.Operations.Movie.Search.POST.Sort as Sort
import qualified StarTrek.Types.MovieBaseResponse as MovieBaseResponse
