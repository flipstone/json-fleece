...
module StarTrek.Operations.Movie.Search
  ( operation
  , route
  , QueryParams(..)
  , queryParamsSchema
...
import qualified StarTrek.Operations.Movie.Search.ApiKey as ApiKey
import qualified StarTrek.Operations.Movie.Search.PageNumber as PageNumber
import qualified StarTrek.Operations.Movie.Search.PageSize as PageSize
