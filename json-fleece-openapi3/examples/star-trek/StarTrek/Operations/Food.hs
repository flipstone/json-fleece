...
import qualified StarTrek.Operations.Food.ApiKey as ApiKey
import qualified StarTrek.Operations.Food.Uid as Uid
import qualified StarTrek.Types.Error as Error
import qualified StarTrek.Types.FoodFullResponse as FoodFullResponse
...
data Responses
  = Response200 FoodFullResponse.FoodFullResponse
