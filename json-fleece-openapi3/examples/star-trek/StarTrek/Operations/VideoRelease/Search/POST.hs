...
module StarTrek.Operations.VideoRelease.Search.POST
  ( operation
  , route
  , QueryParams(..)
  , queryParamsSchema
...
import qualified StarTrek.Operations.VideoRelease.Search.POST.ApiKey as ApiKey
import qualified StarTrek.Operations.VideoRelease.Search.POST.PageNumber as PageNumber
import qualified StarTrek.Operations.VideoRelease.Search.POST.PageSize as PageSize
import qualified StarTrek.Operations.VideoRelease.Search.POST.Sort as Sort
import qualified StarTrek.Types.VideoReleaseBaseResponse as VideoReleaseBaseResponse
