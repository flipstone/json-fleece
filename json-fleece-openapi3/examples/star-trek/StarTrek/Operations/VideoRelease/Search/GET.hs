...
module StarTrek.Operations.VideoRelease.Search.GET
  ( operation
  , route
  , QueryParams(..)
  , queryParamsSchema
...
import qualified StarTrek.Operations.VideoRelease.Search.GET.ApiKey as ApiKey
import qualified StarTrek.Operations.VideoRelease.Search.GET.PageNumber as PageNumber
import qualified StarTrek.Operations.VideoRelease.Search.GET.PageSize as PageSize
