...
module StarTrek.Operations.VideoRelease.Search
  ( operation
  , PathParams(..)
  , route
  , QueryParams(..)
...
import qualified StarTrek.Operations.VideoRelease.Search.ApiKey as ApiKey
import qualified StarTrek.Operations.VideoRelease.Search.PageNumber as PageNumber
import qualified StarTrek.Operations.VideoRelease.Search.PageSize as PageSize
