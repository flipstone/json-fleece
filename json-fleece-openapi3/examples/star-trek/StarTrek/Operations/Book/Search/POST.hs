...
module StarTrek.Operations.Book.Search.POST
  ( operation
  , route
  , QueryParams(..)
  , queryParamsSchema
...
import qualified StarTrek.Operations.Book.Search.POST.ApiKey as ApiKey
import qualified StarTrek.Operations.Book.Search.POST.PageNumber as PageNumber
import qualified StarTrek.Operations.Book.Search.POST.PageSize as PageSize
import qualified StarTrek.Operations.Book.Search.POST.Sort as Sort
import qualified StarTrek.Types.BookBaseResponse as BookBaseResponse
