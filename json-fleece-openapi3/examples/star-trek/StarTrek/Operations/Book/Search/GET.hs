...
module StarTrek.Operations.Book.Search.GET
  ( operation
  , route
  , QueryParams(..)
  , queryParamsSchema
...
import qualified StarTrek.Operations.Book.Search.GET.ApiKey as ApiKey
import qualified StarTrek.Operations.Book.Search.GET.PageNumber as PageNumber
import qualified StarTrek.Operations.Book.Search.GET.PageSize as PageSize
