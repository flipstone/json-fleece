...
module StarTrek.Operations.ComicStrip.Search
  ( operation
  , PathParams(..)
  , route
  , QueryParams(..)
...
import qualified StarTrek.Operations.ComicStrip.Search.ApiKey as ApiKey
import qualified StarTrek.Operations.ComicStrip.Search.PageNumber as PageNumber
import qualified StarTrek.Operations.ComicStrip.Search.PageSize as PageSize
