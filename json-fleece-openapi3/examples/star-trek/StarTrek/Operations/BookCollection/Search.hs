...
module StarTrek.Operations.BookCollection.Search
  ( PathParams(..)
  , route
  , QueryParams(..)
  , queryParamsSchema
...
import qualified StarTrek.Operations.BookCollection.Search.ApiKey as ApiKey
import qualified StarTrek.Operations.BookCollection.Search.PageNumber as PageNumber
import qualified StarTrek.Operations.BookCollection.Search.PageSize as PageSize
