...
module StarTrek.Operations.Animal.Search.GET
  ( operation
  , route
  , QueryParams(..)
  , queryParamsSchema
...
import qualified StarTrek.Operations.Animal.Search.GET.ApiKey as ApiKey
import qualified StarTrek.Operations.Animal.Search.GET.PageNumber as PageNumber
import qualified StarTrek.Operations.Animal.Search.GET.PageSize as PageSize
