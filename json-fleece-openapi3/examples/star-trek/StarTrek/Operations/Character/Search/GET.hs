...
module StarTrek.Operations.Character.Search.GET
  ( operation
  , route
  , QueryParams(..)
  , queryParamsSchema
...
import qualified StarTrek.Operations.Character.Search.GET.ApiKey as ApiKey
import qualified StarTrek.Operations.Character.Search.GET.PageNumber as PageNumber
import qualified StarTrek.Operations.Character.Search.GET.PageSize as PageSize
