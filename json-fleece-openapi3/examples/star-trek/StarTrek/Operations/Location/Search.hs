...
module StarTrek.Operations.Location.Search
  ( operation
  , PathParams(..)
  , route
  , QueryParams(..)
...
import qualified StarTrek.Operations.Location.Search.ApiKey as ApiKey
import qualified StarTrek.Operations.Location.Search.PageNumber as PageNumber
import qualified StarTrek.Operations.Location.Search.PageSize as PageSize
