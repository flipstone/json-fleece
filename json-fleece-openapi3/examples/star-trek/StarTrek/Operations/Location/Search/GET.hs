...
module StarTrek.Operations.Location.Search.GET
  ( operation
  , route
  , QueryParams(..)
  , queryParamsSchema
...
import qualified StarTrek.Operations.Location.Search.GET.ApiKey as ApiKey
import qualified StarTrek.Operations.Location.Search.GET.PageNumber as PageNumber
import qualified StarTrek.Operations.Location.Search.GET.PageSize as PageSize
