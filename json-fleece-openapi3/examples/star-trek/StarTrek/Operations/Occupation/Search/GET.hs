...
module StarTrek.Operations.Occupation.Search.GET
  ( operation
  , route
  , QueryParams(..)
  , queryParamsSchema
...
import qualified StarTrek.Operations.Occupation.Search.GET.ApiKey as ApiKey
import qualified StarTrek.Operations.Occupation.Search.GET.PageNumber as PageNumber
import qualified StarTrek.Operations.Occupation.Search.GET.PageSize as PageSize
