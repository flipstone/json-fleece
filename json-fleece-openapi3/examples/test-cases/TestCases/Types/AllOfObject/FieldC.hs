...
module TestCases.Types.AllOfObject.FieldC
  ( FieldC(..)
  , fieldCSchema
  ) where
...
import qualified TestCases.Types.AllOfObject.FieldC.FieldC1 as FieldC1
import qualified TestCases.Types.AllOfObject.FieldC.FieldC2 as FieldC2
