...
module TestCases.Operations.TestCases.HeadersWithCookies
  ( operation
  , route
  , HeaderParams(..)
  , headerParamsSchema
...
import qualified TestCases.Operations.TestCases.HeadersWithCookies.CookieParamA as CookieParamA
import qualified TestCases.Operations.TestCases.HeadersWithCookies.CookieParamB as CookieParamB
import qualified TestCases.Operations.TestCases.HeadersWithCookies.HeaderParam as HeaderParam
...
headerParamsSchema =
  P.makeParams HeaderParams
    ?+ P.required headerParam HeaderParam.paramDef
