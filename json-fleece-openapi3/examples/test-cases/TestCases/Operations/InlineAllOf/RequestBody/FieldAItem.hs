...
module TestCases.Operations.InlineAllOf.RequestBody.FieldAItem
  ( FieldAItem(..)
  , fieldAItemSchema
  ) where
...
fieldAItemSchema =
  FC.coerceSchema $
    FC.unionNamed (FC.qualifiedName "TestCases.Operations.InlineAllOf.RequestBody.FieldAItem" "FieldAItem") $
