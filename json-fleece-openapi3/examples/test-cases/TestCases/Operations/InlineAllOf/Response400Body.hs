...
module TestCases.Operations.InlineAllOf.Response400Body
  ( Response400Body(..)
...
import qualified TestCases.Operations.InlineAllOf.Response400Body.Bad as Bad
import qualified TestCases.Operations.InlineAllOf.Response400Body.Error as Error
